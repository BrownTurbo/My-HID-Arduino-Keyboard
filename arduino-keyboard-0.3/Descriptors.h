...
typedef struct
{
	...
	// Interface 1: Consumer Media Remote
	USB_Descriptor_Interface_t            HID_MediaInterface;
	USB_HID_Descriptor_t                  HID_MediaHID;
	USB_Descriptor_Endpoint_t             HID_MediaINEndpoint;
...
#define MEDIA_EPNUM                  2 // New dedicated data endpoint
#define MEDIA_EPSIZE                 8
