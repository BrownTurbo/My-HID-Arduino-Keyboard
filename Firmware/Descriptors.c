...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM MediaReport[] =
{
    ...
    0x15, 0x00,          /* Logical Minimum (0) */
    0x26, 0xFF, 0x03,    /* Logical Maximum (1023) - 16-bit little endian */
    0x19, 0x00,          /* Usage Minimum (0) */
    0x2A, 0xFF, 0x03,    /* Usage Maximum (1023) - 16-bit little endian */
	...
	.HID_MediaInterface =
		{
			...
			.SubClass               = 0x00, // No boot subclass
			.Protocol               = 0x00, // None
			.InterfaceStrIndex      = NO_DESCRIPTOR
		},
	.HID_MediaHID =
	...
	switch (DescriptorType)
	{
		...
		case DTYPE_HID: 
			if (wIndex == 0) {
				...
				Address = (void*)&ConfigurationDescriptor.HID_MediaHID;
				Size    = sizeof(USB_HID_Descriptor_t);
			}
			break;
		case DTYPE_Report:
			if (wIndex == 0) { // Interface 0 asks for report
				Address = (void*)&KeyboardReport;
				Size    = sizeof(KeyboardReport);
			} else {           // Interface 1 asks for report
				Address = (void*)&MediaReport;
